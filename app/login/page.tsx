...
export default function LoginPage() {
    ...
    const [view, setView] = useState<"selection" | "email" | "phone">("email");

    // Email State
    const [emailCreds, setEmailCreds] = useState({ email: "demo@studiox.com", password: "DemoPassword123!" });
    ...
    const handleEmailSubmit = async (e: React.FormEvent) => {
        ...
        if (emailCreds.email !== "demo@studiox.com" || emailCreds.password !== "DemoPassword123!") {
            setError("Login is temporarily disabled. Only the demo account is accessible.");
            return;
        }
        ...
        try {
            ...
            if (err.name === 'AbortError' || err.message === 'The operation was aborted.') {
                // Ignore AbortError coming from Next.js concurrent router pushes
                ...
                >
                    ...
                    <div className="relative p-10 z-10">
                            ...
                            {view === "email" && (
                                ...
                                >
                                    <div className="flex items-center mb-6">
                                        <h3 className="text-white font-medium text-lg">Demo Login Access</h3>
                                    </div>
                                    <p className="text-white/60 text-sm mb-6">Public login is temporarily disabled. Please use the demo credentials below to access the platform.</p>
                        ...
                        <div className="mt-8 text-center text-xs">
                            <span className="text-white/50">Public registration is currently disabled.</span>
                        </div>
                    </div>
